...
export default class ProductCatalog {
  ...
  private static _productItems: Map<string, ProductItem> = new Map([
    [
      "1",
      new ProductItem("1", "Irish rugby shirt", 55.99, 20001, "2015-05-09"),
    ],
    ["2", new ProductItem("2", "Space Marine", 49.99, 15009, "2018-12-08")],
    ["3", new ProductItem("3", "Necron Sport", 4_000_000, 4, "2017-12-25")],
  ]);

  static getAllProductItems(): Array<ProductItem> {
    let productItemsAsIterable: Iterable<ProductItem> =
